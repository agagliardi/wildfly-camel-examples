...
This example demonstrates using the camel-cxf component with WildFly Camel to produce and consume JAX-WS web services.
...
4. Browse to http://localhost:8080/example-camel-cxf-jaxws/
...
Testing Camel CXF JAX-WS over JMS
------------------------

Web UI
------

Browse to http://localhost:8080/example-camel-cxf-jaxws-over-jms/.
...
The full Camel route can be seen in `src/main/webapp/WEB-INF/cxfws-cameljms-context.xml`.
